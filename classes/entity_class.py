...
class Entity:
	...
	# def __init__(self, name, subject, snomed_code, typ, medication_route, medication_allergy, medication_strength, medication_frequency, medication_duration, medication_dosage):
	...
	# #symptom constructor
	# def __init__(self, name, subject, snomed_code, typ, symptom_body_laterality, symptom_history, symptom_duration, symptom_start_time, symptom_severity, symptom_body_location):
	...
	# #anatomy constructor
	# def __init__(self, name, subject, snomed_code, typ, anatomy_body_laterality, anatomy_body_side):
	# 	# required entity parameters
	# 	self._name = name
	# 	self._snomed_code = snomed_code
	# 	self._type = typ
	...
	# def __init__(self, name, subject, snomed_code, typ, procedure_duration, procedure_method, procedure_start_time, procedure_end_time, procedure_body_location, procedure_device):
	# 	# required entity parameters
	# 	self._name = name
	# 	self._snomed_code = snomed_code
	# 	self._type = typ
	...
	# #disease constructor
	# def __init__(self, name, subject, snomed_code, typ, disease_course, disease_start_time, disease_end_time, disease_associated_symptom, disease_body_location, disease_severity, disease_alleviating_factor, disease_exacerbating_factor):
	# 	# required entity parameters
	# 	self._name = name
	# 	self._snomed_code = snomed_code
	# 	self._type = typ
